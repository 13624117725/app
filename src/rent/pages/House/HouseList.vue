...
<template>
    <div class="house-list" >
        ...
        <div class="header" :class="{iosheader:isWex,andHeader:isAnd}">
        	<div style="width: 1.3rem;height: 1.3rem;float: left;" @click="back">
         ...
         <div class="type-search" :class="{wextypesearch:isWex}">
                <flexbox class="isnotLinerent" :class="{isonLinerentWex:isWex}">
                    <flexbox-item>
                        <div class="flex-demo" @click="regionClick">
                                <span class="regionName" :class="{regionarea:regionClass}">{{regionName}}</span>
                                <img class="open-icon" v-if="region || regionClass" :src="openUrl" :class="{isnewhouse:isnewhouse}"/>
                                <img class="stop-icon" v-if="!region && !regionClass" :src="stopUrl" :class="{isnewhouse:isnewhouse}"/>
                                <span class="long-string" :class="{notnewhouse:isonLinerent}"></span>
                        </div>
                    </flexbox-item>
                    <flexbox-item>
                        <div class="flex-demo" @click="subwayClick">
                                <span class="regionName" :class="{regionarea:subwayClass}">{{subwayName}}</span>
                    ...
                    <flexbox-item>
                        <div class="flex-demo" @click="priceClick">
                                <span class="regionName" :class="{regionarea:priceClass}">{{priceName}}</span>
        ...
        <!-- 筛选 -->
        <div v-show="filtrate" class="regloinlists">
                ...
                >
                        <div class="list-item" :class="{ioslistitem:!isAndrion,wexlist:isWex}">
                            <ul class="table-view">
                                ...
                                <li class="table-view-list-houseList" v-for="item in HouseLists" :key="item.id" @click="goHouseDetail(item.id,item.productType)">
                                	<div class="list-top">
                                		<div class="imgOnehouseList">
                                			<img class="pull-left" v-lazy="item.image || noDetailImg " style="position: relative;">
                                			<!--品质节logo-->
                                			...
                                			<div class="houseMoney">
                                				<div class="houseMoneyNum">{{item.price}}</div><div class="houseMoneyCHN">&nbsp;元&nbsp;/&nbsp;月</div>
                                			</div>
                                		</div>
                                		<div class="imgRight-houseList">
                                			<div class="imgTwo">
                                				<img class="pull-left" v-lazy="concatFileUrl(item.attachImage[0]) || noimg">
                                			</div>
                                			<div class="imgThree">
                                				<img class="pull-left" v-lazy="item.attachImage[1] ? concatFileUrl(item.attachImage[1]) : noimg ">
...
<script>
    ...
    // import noDetailImg from "https://img.guoanfamily.com/rent/static/HomePage/noneImg1.png";
    ...
    export default {
        ...
        data() {
            return {
                ...
                loadings:true,
                loading:"加载中",
                noDetailImg :"https://img.guoanfamily.com/rent/static/HomePage/noneImg1.png",
                noimg:"https://img.guoanfamily.com/rent/static/HomePage/noimgAPP.jpg",
        ...
        created() {
            if(this.$route.query.name &&!this.getSession(this.KEYS.SEARCH_CONTENT)){
        ...
        //列表事件
            activated(){
                ...
                // console.log(this.getSession(this.KEYS.SEARCH_CONTENT))
                if(this.getSession(this.KEYS.SEARCH_CONTENT)){   //房源进搜索 返回
                    ...
                    this.$refs.regionCommpont.regionClear("区域");
                    ...
                    if(this.$route.query.name ||this.$route.query.housecode){   //首页点击好房或整租进房源列表
                        ...
                        if(this.isFiltrateClass){
                            ...
                            this.HouseListData.textSearch = this.$route.query.housecode;
                            this.headerSearch = this.$route.query.housecode;
                        }
                        ...
                        this.post("common/getAreaList",{}).then((res)=>{
                            ...
                            res.forEach(item=>{
                                if(item.name===this.$route.query.search){
                                    ...
                                    this.HouseListData.districtId = item.id;
                                    this.regionName = item.name;
                                    this.isRegionClass = true;
                                    this.regionClass = true;
                                    this.$refs.regionCommpont.regionClear("search2");
                                    this.HouseLists = [];
                                    // this.isUpload = true;
                                    this.HouseListData.timeStamp = 0;
                                    this.getHouseList();
            ...
            deactivated(){
                if(this.$route.path=='/HomePage' || this.$route.path=='/' ||this.$route.path=='/Apartment' ||this.$route.path=='//HouseList/HotSearch'){
        ...
        methods: {
             ...
             getRegionSubway(){
                ...
                if(this.region && this.isType=="region"){
                    ...
                    this.post(url,{}).then((res)=>{
                        ...
                        if(this.subway && this.isType=="subway"){
            ...
            //区域返回数据
            changeRegionSubway(data,regionId,name){
                this.HouseListData.districtId = data.isAreaTypeid || "";    //区域ID
                this.HouseListData.regionId =  regionId || "";   //具体ID
                this.HouseListData.textSearch= "";
                this.headerSearch = "";
                if(data.isAreaTypeid || regionId){
                    this.regionClass = true;
                    this.isRegionClass = true;
                    this.isUpload = true;
                }else{
            ...
            //地铁返回数据
            changeSubway(id,subwayLineId,name){
                this.HouseListData.stationsId = id || "";
                this.HouseListData.subwayLineId = subwayLineId.isAreaTypeid || "";
                if( id || subwayLineId.isAreaTypeid){
                ...
                if(id || subwayLineId.isAreaTypeid){
                    ...
                    if(id){
                        ...
                        this.subwayName = subwayLineId.name;
                    }
                    this.market = false;
                    this.subway = false;
                    this.region = false;
