...
<template>
    <div class="container fixContent">
        ...
        <img style="width: 50%;margin: 0 auto;padding-top: 100px;" @click="homePage()" v-if="isHad" src="../../../assets/home/bg.png">
        <!--<ga-page-header >
            <p slot="middle">
                <input type="text">
            </p>
        ...
        <!-- 账单 -->
        <div v-if="!isHad" class="list-box" :class="{'wex-list':iswex}">
                ...
                <div class="bill" v-for="(item,index) in receiptPlanList[swiperItemIndex]" :key="index">
                    ...
                    <div class="bottom">
                        <div class="fy">
                            ...
                            <div class="dzf" v-if="item.realRent>0" @click="payDetails(item.receiptPlanId)"><span class="span" :class="{nopaystatus:item.payStatus}">支付详情</span></div>
