...
<template>
	<div >
		<div class="content" :class="{contentWx:this.$store.state.showWxTitle}">
			<div class="content-room">
				...
				<p class="content-room-title3"><span style="font-family: font01;">{{rentPrice}}</span>元/月</p>
			...
			<div class="content-date">
				<div class="content-data-inner">
					<div style="width: 0.1rem;height: 1rem;float: left;"></div>
		...
		<div class="payBtn" @click="toAppointSuccess">
