...
<template>
    <div class="map-route" :class="{'wx-heat-map':isWex}">
        ...
        <div class="location">
            ...
            <div class="user-location" @click="setUsetLocation" v-if="!platform">
                <span class="radius"></span>
                <span>当前位置</span>
            </div>
        </div>
        ...
        <div class="circuit-panel" v-show="isMessageList" :class="{'touchmove-css':isTouchmove}">
            <ul class="vehicle" @touchmove="messageTouchmove" @touchstart="messageTouchstart">
                <li v-if="publics" @click="publicClick">公交</li>
            ...
            if(this.platform){
                this.$wechat.getLocation({
                    ...
                    success:  (res)=> {
                        ...
                        this.p1 = new BMap.Point(res.longitude,res.latitude);
                        this.drawLine(0);
                    }
                });
