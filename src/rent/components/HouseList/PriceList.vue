<style scoped lang="scss">
 ...
 <template>
    ...
    <transition name="bounce">
         <div class="regloin" v-if="isSearchShow" :class="{iosregloin:isWex,isand:isAndrion}">
            <div class="search-house-list">
             ...
             <div class="buttons ipxButton">
                <button class="subMit1" @click="allBuildClick">确定</button>
                <button class="exit1" @click="allBuildExitClick">重置</button>
            </div>
        </div>
    </transition>
</template>
             ...
             return{
                demo: {
                    ...
                    sliderStyle:{
                        ...
                        background:'url("https://img.guoanfamily.com/price-icon.png") no-repeat',
                        backgroundSize:'100%',
                    }
                },
                isAndrion:false,
