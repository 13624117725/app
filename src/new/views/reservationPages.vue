<template>
    <div class='fixContent reservation'>
        <div :class="{'collentTop':IosTop,'collentTop1':AndroidTop,'collentWxTop':this.$store.state.showWxTitle}">
            <div class='topContent'>
                ...
                <div class='topContentRight'>
                    ...
                    <div class="topContentRightPrice"><span style="font-family: font01;">{{BuildPrice}}</span>/㎡</div>
                    <div class="topContentRightArea">面积:{{BuildArea}}㎡</div>
            ...
            <div class="labelStyle">
                <span class="labelStyleName">姓名</span>
                <input class="labelStyleInput" type="text" placeholder="请输入姓名" v-model='username'>
                <!-- <x-input class="leftName" title="姓名" name="username" v-model='username' :show-clear='false' placeholder="请输入姓名"></x-input> -->
            </div>
            <div class="labelStyle">
                <span class="labelStyleName">电话</span>
                <input class="labelStyleInput" type="number" placeholder="请输入电话" v-model='userPhone'>
            ...
            <div class="labelStyle">
                <span class="labelStyleName">人数</span>
                <input class="labelStyleInput" type="text" placeholder="请输入人数" v-model='numPeople'>
            ...
            <div class="labelStyle">
                <!-- <span class="labelStyleName">时间</span>
                <input class="labelStyleInput" :value="selecteddate" type="text" placeholder="请选择看房时间"> -->
                <datetime-range class="labelStyle" style="font-size:.3rem;margin-left: 0.3rem;" title="时间" placeholder="请选择看房时间" :start-date="startdate" :end-date="enddate" :value="Showingsdate" @on-change="onChange" ></datetime-range>
                <!-- <x-input class="leftName" title="人数" name="numPeople" v-model='numPeople' keyboard="number" :show-clear='false'  placeholder="请输入看房人数"></x-input> -->
            </div>
        ...
        <!-- 提交按钮 -->
        <div class='subBtn ipxButton' @click='subClick'>
            <div class="button">提交约看</div>
        </div>
    </div>
</template>
...
export default {
   ...
   methods:{
    ...
    //    时间选择框
        ...
        getType(){
            if(this.isECTouch()){
                return "国安家app-微信";//国安家APP-微信渠道
            }else{
                return "国安家app";   //国安家APP
            }
        },
        // 提交约看的点击事件
        subClick(){
