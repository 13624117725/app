            ...
            saveDisheStore(){
                ...
                this.post("order/restaurant/updateDishes",upDishies).then(res=>{
                    if(res.code==200){
                        ...
                        window.location.href = 'https://www.guoanfamily.com/commonPlatform/pay/membershipPayment.html?time='+((new Date()).getTime())+'&id=' + this.openid + '&notifyUrl=' + this.notifyUrl + '&totalFee=' + this.totalFee + '&orderid=' + this.orderid + '&body=' + encodeURIComponent(this.body) + '&callBackUrl='+encodeURIComponent(this.callBackUrl);
                    }
                })
            },
