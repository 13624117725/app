...
<script>
import videoandimg from './../components/newhouse/builddetail/videoandimg';
import housetypelist from './../components/newhouse/builddetail/housetypelist';
import builddetail from './../components/newhouse/builddetail/builddetail';
import ratingandecharts from './../components/newhouse/builddetail/ratingandecharts';
import newhousefooter from './../components/newhouse/builddetail/newhousefooter';
...
export default {
    ...
    created(){
        this.get(`/buildapp/BuildBaseInfoA/buildparticularsid?buildid=${this.$route.query.buildID}${this.$route.query.buildID}`,{
