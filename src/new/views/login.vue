    ...
    <div :class="[this.$store.state.loginShow ? 'login_show' :'login_top' ]"> 
        ...
        <div class="loginCenter" ref="loginCenter" :style="{'height':centerBox+'px'}">
            ...
            <div class="inputBox">
              ...
              <div class="box">
                <div class="inputTel animated" :class="{flipInX:isanimated}">
                  ...
                  <input type="number" v-model.number="phoneNumber" maxlength="11" @input="handleTel" placeholder="请输入手机号码" id="inputBlur" @click="phoneClick('1')">
                </div>
            ...
            <div class="buttonBox">
              ...
              <img class="animated bounceIn" src="../../../static/new/img/loginYes.png" alt="">
            </div>
            <div class="telBox">
  ...
  methods: {
    ...
    login() {
      ...
      if (!this.notEmpty(erweima)) {
        ...
        this.post("userLoginController/register", post_data, {
          interfaceType: "collect"
        }).then(
          response => {
            if (response.code == 200) {
    ...
    saveReg(rId){
      ...
      // let url = 'userInfoController/unionSaveJpushID?RegistrationID=' + rId + '&Platform=' + platform;
...
.loginTop {
  width: 100%;
  height: 30%;
  background: url("https://img.guoanfamily.com/www/loginTop.jpg") no-repeat
    center;
