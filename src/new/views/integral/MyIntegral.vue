  ...
  .integral_title {
    ...
    .btn_box_Integral {
      ...
      .btn_style {
        ...
        color: #e34b3e;
        width: 32%;
        background:url("../../../../static/new/img/integral.png") no-repeat;
        background-size:100%;
      ...
      .right_btn {
        background:url("../../../../static/new/img/deposit.png") no-repeat;
        background-size:100%;
        left: 65%;
      }
    }
      ...
      <div class="MyIntegral" :class="{'user_set1':this.$store.state.showWxTitle,'user_set':!this.$store.state.showWxTitle}">
        ...
        <div class="integral_title">
            ...
            <div class="btn_box_Integral ">
                <div class="btn_style" @click="ToShowMsg"></div>
                <div class="btn_style right_btn" @click="Withdrawals"></div>
            </div>
        </div>
        <!-- 提示 -->
        <div class="infoName">
