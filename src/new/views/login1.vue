<template>
    <div  :class="[this.$store.state.loginShow ? 'login_show' :'login_top' ]">
        ...
        <div class="loginCenter" ref="loginCenter" :style="{'height':centerBox+'px'}" :class="{wexcss:isWex}">
            ...
            <div class="inputBox">
              ...
              <div class="box">
                <div class="inputTel animated" :class="{flipInX:isanimated}">
                  ...
                  <!-- <input @blur="goTopBlur" class="inputTel-input" type="tel" pattern="\d" v-model.number="phoneNumber" maxlength="11" @input="handleTel"  placeholder="请输入手机号码" id="inputBlur" @click="phoneClick('1')"/> -->
                  <input @focus="bottomFocus" @blur="goTopBlur" class="inputTel-input" type="tel" pattern="\d" v-model.number="phoneNumber" maxlength="11" @input="handleTel"  placeholder="请输入手机号码" id="inputBlur" />
                </div>
                ...
                <div class="inputVerify animated" :class="{flipInX:isanimated}">
                  ...
                  <!-- <input class="inputVerify-input" type="number" v-model.number="vistionCode" maxlength="6" @input="authCodeInput" placeholder="请输入验证码" id="inputBlur2" @click="phoneClick('2')"/> -->
                  <input @focus="bottomFocus" @blur="goTopBlur" class="inputVerify-input" type="number" v-model.number="vistionCode" maxlength="6" @input="authCodeInput" placeholder="请输入验证码" id="inputBlur2" />
...
export default {
  ...
  methods: {
    ...
    login() {
      ...
      //当用户打开app后登陆时，若有正确的验证码可直接登陆，不用再提示先获取验证码。2018-11-27，仅注释了一下部分。
//    if(this.issecond==1){
//      if(this.phoneNumber =="13512345678"){
//
//      }else{
//        this.isshades = true;
//        this.shdeModel = "请先获取验证码";
//        // this.phoneNumber = "";
//        this.hiddenShade(); //两秒自动关闭弹出层
//        return false;
//      }
...
.loginTop {
  width: 100%;
  height: 30%;
  background: url("https://img.guoanfamily.com/www/loginTop1.jpg") no-repeat
    center;
